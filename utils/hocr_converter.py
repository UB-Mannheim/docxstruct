...
# todo this is same class like in python ocr: maybe find common ground for this
...
class HocrConverter(object):
    ...
    def hocr2df(self, filename, ocr=None, ocr_profile=None, index=None, additional_profiles=[], mode_ocromore=False):
        """
        ...
        if not ocr_profile or str.lower(ocr_profile) not in ["abbyy","ocro","tess"]:
            if not ocr_profile or str.lower(ocr_profile) not in additional_profiles:
                ocr_profile = "default"
        ...
        df_dict = {"Ocro": self.create_dict_ocropus,
              ...
              "Ocromore": self.create_dict_ocromore,
    ...
    def create_dict_ocromore(self,document,ocr_profile=None):
        """
        ...
        """
        ocr = "ocromore"
        if ocr_profile is not None and str.lower(ocr_profile) in ["abbyy","tess","ocro"]:
